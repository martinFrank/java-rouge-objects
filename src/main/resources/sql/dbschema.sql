...
create TABLE IF NOT EXISTS Skill (id IDENTITY NOT NULL, name VARCHAR(255), action VARCHAR(255), PRIMARY KEY ( id ))
...
#create TABLE IF NOT EXISTS ItemType (id IDENTITY NOT NULL, equipmentslottype LONG NOT NULL, name VARCHAR(255), PRIMARY KEY ( id ), FOREIGN KEY (equipmentslottype) REFERENCES EquipmentSlotType(id))
